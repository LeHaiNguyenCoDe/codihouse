<template>
  <section class="project-overview absolute left-0 right-0 bg-white px-8 w-full/12">
      <div class="project-title text-6xl text-gray-700 leading-relaxed font-sans font-bold px-8 ">
          ...
          {{ projectOverview.content1 }}<br />
          {{ projectOverview.content2 }}
          <span class="highlight-gradient font-bold bg-gradient-to-r from-[#A1CC95] via-[#26AAE1] to-[#26AAE1]
         bg-[10%] bg-clip-text text-transparent px-2 py-1 rounded-md">
              {{ projectOverview.highlight2 }}
              <img :src="water" alt="water">
          </span>
          {{ projectOverview.content3 }}<br />
          {{ projectOverview.content4 }}
      </div>
      
      <p class="project-description w-1/2 font-sans text-black ml-auto text-sm text-gray-500 px-8 -mt-1/20">
        {{ miniView.details }}
      </p>
      
      <div class="project-video absolute left-1/27 w-11/12 h-full mt-24 z-10">
      ...
      <div class="project-background mt-24">
          <img :src="group_bg" alt="" class="absolute top-1/3 left-0">
          <img :src="bg_ellipse" alt="" class="absolute top-1/3 right-0">
      </div>
  </section>
</template>
...
const projectOverview = {
  ...
  highlight1: "Đổi mới",
  content1: " giao diện website, ",
  content2: "  lan tỏa ",
  highlight2: "sự rực rỡ",
  content3: " và nâng cao",
  content4: "  hiệu quả tương tác."
};
